...
?sample_n()
population_table <- read.csv('C:/Users/Ella/OneDrive/Desktop/Class_Assignments/R_Analysis/01_Demo/used_car_data.csv',check.names = F,stringsAsFactors = F) #import used car dataset
